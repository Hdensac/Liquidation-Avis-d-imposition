      ...
      <div className="md:hidden space-y-3">
          ...
          return (
            <div
              ...
              className={`p-4 rounded-xl border bg-white shadow-sm space-y-3 ${
                hasBeenDownloaded ? "border-l-4 border-l-emerald-500 border-slate-200" : "border-slate-200"
              }`}
            >
              ...
              <div className="flex items-center justify-between gap-2 pt-2 border-t border-slate-100">
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    {pdfLoadingId === liq.id ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Download className="w-3.5 h-3.5" />}
                    Avis PDF
                  </button>
                  {hasBeenDownloaded ? (
                    ...
                    <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full bg-slate-100 text-slate-400 font-semibold border border-slate-200">
                      📥 0
                    </span>
                  )}
                </div>
                ...
                {canEdit && isRoleActif && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 text-xs font-semibold py-1.5 px-3 rounded-lg transition"
                  >
        ...
        {filteredAvisList.length === 0 && (
          <div className="p-8 text-center text-sm text-slate-500 bg-white rounded-xl border border-slate-200">
            {searchQuery ? "Aucun avis ne correspond à votre recherche." : "Aucun avis TPS validé."}
          </div>
        )}
      </div>
