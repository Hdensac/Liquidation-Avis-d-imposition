          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50 text-[11px] font-semibold text-slate-600 uppercase tracking-wider">
              <tr>
                ...
                <th className="px-6 py-4 text-left">Rôle — Statut</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-xs">
                      <div className="flex flex-col gap-1">
                        <span className="font-medium text-slate-500">{roleName}</span>
                        {roleStatus === "ACTIF" ? (
                          <span className="inline-flex items-center gap-1 w-fit px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-100 text-emerald-700">
                            ACTIF
                          </span>
                        ) : roleStatus === "CLOTURE" ? (
                          <span className="inline-flex items-center gap-1 w-fit px-2 py-0.5 rounded-full text-[10px] font-semibold bg-gray-200 text-gray-500">
