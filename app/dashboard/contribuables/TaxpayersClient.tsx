                          ...
                          <tr key={l.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                            ...
                            <td className="py-3 px-4 text-center">
                              {l.status === "PAYE" || l.status === "VALIDE" ? (
                                ...
                                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border border-slate-300 dark:border-slate-600">
                                  ANNULÉ
                                </span>
                              ) : (
